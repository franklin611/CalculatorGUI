...
public class CalculatorGUI extends javax.swing.JFrame {
    ...
    public CalculatorGUI() {
        // this.pastNumber = Double.parseDouble(jTextField1.getText());
        initComponents();
    }
    ...
    public void arithmetic_operations() {
        // double pastNumber;
        if (counter == 0) {
            this.currentNumber = Double.parseDouble(jTextField1.getText());
        } else {
            currentNumber = placeHolder;
        }

        switch (calculations) {
            case 1 -> {  //Addition
                answer = PastNumber + currentNumber;
                jTextField1.setText("");
            ...
            case 3 -> { // Multiplication
                answer = PastNumber * currentNumber;
                //String test = Double.toString().substring()
                jTextField1.setText("");
                jTextField1.setText(Double.toString(answer));
    ...
    private void initComponents() {
        ...
        jTextField1.setBackground(new java.awt.Color(207, 255, 211));
        jTextField1.setFont(new java.awt.Font("Dialog", 1, 48)); // NOI18N
        jTextField1.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jTextField1.setText(" ");
        jTextField1.setAlignmentY(0.0F);
        jTextField1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204), 5));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        counter = 0;
        PastNumber = Double.parseDouble(jTextField1.getText());
        calculations = 4;
        jTextField1.setText("");
